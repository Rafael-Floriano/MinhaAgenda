...
public partial class AdicionarContatoPage : ContentPage
{
    ...
    {
        await _adicionarContatoUseCase.ExecutaAsync(new CoreBusiness.Entidades.Contato(contatosCtrl.Name, contatosCtrl.Phone, contatosCtrl.Email, contatosCtrl.Address, contatosCtrl.Observation));
